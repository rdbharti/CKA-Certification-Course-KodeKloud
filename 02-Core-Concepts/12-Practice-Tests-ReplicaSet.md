...
1. <details>
   ...
   - Then delete the pods associated with new-replica-set.
     - First find labels associated with the conatiner in replicaset
       - `kubectl describe rs new-replica-set`
     - Delete the pods
       - `kubectl delete po -l <label>`
     - New Pods with the new images will be automatically spun
